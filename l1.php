...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="user-actions">
            ...
            <img src="./assert/menu.png" alt="Menu Icon" class="menu-icon" onclick="redirectToProfile()"> <!-- Add your menu icon image path here -->
        </div>
    </div>
    ...
    <div class="scan-footer-container">
        <div class="slide-track">
            ...
            <div class="slide-button">
                <img src="./assert/qr-code-scan.png" alt="Scanner Icon"> <!-- Path to your scanner icon -->
            </div>
        </div>
    </div>
</div>
